...
namespace ShowsProject.Controllers
{
    ...
    public class OwnersController : ControllerBase
    {
        ...
        public async Task<ActionResult<Owner>> PostOwner(OwnerDTO ownerDTO)
        {
            if (ownerDTO == null)
            {
                return BadRequest("OwnerDTO is null.");
            }

            // You may want to validate ownerDTO properties or perform any necessary processing before creating the Owner entity

            var owner = new Owner
            {
                // Map properties from ownerDTO to owner as needed
                Name = ownerDTO.Name,
            ...
            if (_context.Owners == null)
            {
                return Problem("Entity set 'LibraryDbContext.Owners' is null.");
            }
